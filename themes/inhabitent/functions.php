...
function red_starter_scripts() {
	...
	wp_enqueue_script('red-script', get_template_directory_uri() . '/build/js/script.min.js', array(), '20151215', true);
	...
	wp_enqueue_script( 'font-awseome', '//kit.fontawesome.com/c14e7bafd7.js' );	
