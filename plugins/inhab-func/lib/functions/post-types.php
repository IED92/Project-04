...
// Register Custom Post Type
function advents_post_type()
{

  $labels = array(
    'name'                  => _x('advents', 'Post Type General Name', 'text_domain'),
    'singular_name'         => _x('advent', 'Post Type Singular Name', 'text_domain'),
...
add_action('init', 'advents_post_type', 0);
