...
<div class="widget-content">
   ...
   <p><label for="<?php echo $this->get_field_id('weekday'); ?>">Monday-Friday:</label>
      <input class="widefat" id="<?php echo $this->get_field_id('weekday'); ?>" name="<?php echo $this->get_field_name('weekday'); ?>" type="text" value="<?php echo $weekday; ?>">
   </p>
